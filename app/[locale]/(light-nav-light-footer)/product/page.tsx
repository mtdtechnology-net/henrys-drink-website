    ...
    <section className="relative w-full min-h-screen bg-[#FBF9F5] flex flex-col lg:flex-row items-center lg:items-start justify-between px-6 sm:px-10 xl:px-23 pt-24 lg:pt-35 pb-24 overflow-x-hidden gap-8 lg:gap-0">
      ...
      >
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          transition={{ duration: 0.2 }}
          className="w-[130px] h-[40px] bg-[#325175] active:bg-[#233a54] rounded-[160px] flex items-center justify-center transition-colors cursor-pointer shadow-sm"
        >
          <span className="font-comfortaa text-[14px] font-medium leading-none text-white text-center">
            Add to cart
          </span>
        </motion.button>
      </motion.div>
