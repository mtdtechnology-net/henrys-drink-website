...
export default function ParisianPage() {
    return (
        <main className="relative min-h-screen min-h-[100svh] w-full overflow-hidden bg-[#110202]">
            ...
            <div className="pointer-events-none absolute top-0 left-0 z-20 h-screen w-[24%] overflow-hidden border border-green-500">
                <Image
            ...
            <div className="pointer-events-none absolute top-0 right-0 z-20 h-screen w-[30%] overflow-hidden border border-green-500">
                <Image
