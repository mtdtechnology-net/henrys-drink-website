...
export default function ProductPage() {
  return (
    <section className="relative w-full min-h-screen bg-[#FBF9F5] flex items-start justify-between px-10 xl:px-23 pt-35 pb-24 overflow-y-auto">
      ...
      <div className="relative z-20 w-84.25 h-244.25 shrink-0 flex justify-center pt-3 -translate-y-[15px]">
        <Image
          src="/henrybottle.svg"
      ...
      <div className="font-comfortaa relative z-10 flex flex-col justify-start gap-16 w-108.75 shrink-0">
        ...
        <div className="space-y-3">
          <h3 className="font-semibold text-[17px] text-[#325175]">
            About This Aperitif
          </h3>
          <div className="text-[#0F0F0F] text-[16px] font-medium leading-7 space-y-6">
            <p>
              Inspired by a family recipe passed down through generations,
              Henry's combines Bordeaux wine, walnut, elderflower, and carefully
              selected spirits to create a refined and distinctive aperitif.
            </p>
            <p>
              Balanced, elegant, and versatile, it can be enjoyed on its own or
              as the foundation of our signature cocktails.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-6 text-[#0F0F0F] text-[16px] font-medium leading-7">
            ...
            <div>
              <p className="text-[#325175] font-semibold">
                Serving Temperature
              </p>
              <p>6–8°C</p>
            </div>
