      ...
      <article className="mx-auto w-full max-w-[1000px] px-6 pb-28 pt-[clamp(7rem,14vh,11rem)] sm:px-10 lg:px-8">
        ...
        >
          <PolicySection title="Delivery Zones">
            <p>
              Henrys ships its products within France and internationally through
              its logistics partner Pelican.
            </p>
          </PolicySection>

          <PolicySection title="Delivery Times">
            <p>
              The average delivery time is a minimum of one business week starting from
              order confirmation.
            </p>

            <p>
              Delivery times may vary depending on the destination country and are
              not guaranteed.
            </p>

            <p>
              Henrys shall not be held responsible for any delays related to
              the carrier, customs, or events of force majeure.
            </p>
          </PolicySection>
            ...
            <div className="space-y-6">
              <div>
                <p>
                  ...
                  the destination and chosen shipping method.
                </p>

                <p>
                  Delivery reserved strictly for adults. In accordance with
                  current legislation, our alcohol-containing products can
                  only be sold and delivered to adults (18 years and older).
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  arrives damaged, incomplete, or non-compliant, the customer must immediately
                  report it to the carrier and contact our customer service at{" "}
                  <a
              ...
              <p>
                ...
                refund or resend the package according to the customer's preference.
              </p>
            </div>
          </PolicySection>
          ...
          <PolicySection title="Customs and Local Taxes">
            <p>
              For deliveries outside the European Union, customs fees
              or local taxes may apply and remain the responsibility of
              the customer.
            </p>
          </PolicySection>
        </motion.div>
