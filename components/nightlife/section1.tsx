...
export default function Section1() {
  return (
    ...
    <div className="absolute inset-0 bg-white/5 z-10" />
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full max-w-7xl mx-auto pt-14 mt-8 lg:mt-20 md:pt-16 2xl:pt-24">
        
        <h1 className="font-pinyon text-6xl sm:text-7xl lg:text-[134px] 2xl:scale-125 min-[1920px]:scale-150 whitespace-normal lg:whitespace-nowrap leading-tight lg:leading-none text-white text-center transform origin-center transition-transform">
        ...
        <button className="mt-20 lg:mt-36 2xl:mt-48 px-8 py-4 2xl:px-12 2xl:py-5 rounded-full bg-[#FFFCF9] font-futura text-lg md:text-[22px] 2xl:text-[26px] font-medium leading-none text-[#442F0E] hover:bg-opacity-90 transition cursor-pointer flex items-center justify-center">
